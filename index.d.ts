...
export function getContactById(
  contactId: string,
  callback: (error: any, contact: Contact) => void
): void;
export function getPhotoForId(
  contactId: string,
  callback: (error: any, photoUri: string) => void
): void;
...
export function openExistingContact(
  contact: Contact,
  callback: (error: any, contact: Contact) => void
): void;
...
export function getContactsMatchingString(
  str: string,
  callback: (error: any, contacts: Contact[]) => void
): void;
export function checkPermission(
  callback: (error: any, result: "authorized" | "denied" | "undefined") => void
): void;
